...
export const contentData: { [key: string]: Content } = {
  en: {
    ...
    colors: [
      ...
      { id: 'en-c-4', display: 'Yellow', word: 'Yellow Sun', imageUrl: 'https://picsum.photos/seed/yellow/200' },
      { id: 'en-c-5', display: 'Orange', word: 'Orange Fruit', imageUrl: 'https://picsum.photos/seed/orange/200' },
      { id: 'en-c-6', display: 'Purple', word: 'Purple Grapes', imageUrl: 'https://picsum.photos/seed/purple/200' },
      { id: 'en-c-7', display: 'Black', word: 'Black Cat', imageUrl: 'https://picsum.photos/seed/black/200' },
      { id: 'en-c-8', display: 'White', word: 'White Snow', imageUrl: 'https://picsum.photos/seed/white/200' },
    ],
    storiesData: [
  ...
  ar: {
    ...
    colors: [
      ...
      { id: 'ar-c-4', display: 'أصفر', word: 'شمس صفراء', imageUrl: 'https://picsum.photos/seed/yellow/200' },
      { id: 'ar-c-5', display: 'برتقالي', word: 'فاكهة البرتقال', imageUrl: 'https://picsum.photos/seed/orange/200' },
      { id: 'ar-c-6', display: 'بنفسجي', word: 'عنب بنفسجي', imageUrl: 'https://picsum.photos/seed/purple/200' },
      { id: 'ar-c-7', display: 'أسود', word: 'قطة سوداء', imageUrl: 'https://picsum.photos/seed/black/200' },
      { id: 'ar-c-8', display: 'أبيض', word: 'ثلج أبيض', imageUrl: 'https://picsum.photos/seed/white/200' },
    ],
    storiesData: [
